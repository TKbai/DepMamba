...
class MambaInnerFnNoOutProj(torch.autograd.Function):
    ...
    def backward(ctx, dout):
        ...
        dconv1d_weight = torch.empty_like(conv1d_weight)
        dconv1d_bias = torch.empty_like(conv1d_bias)
        causal_conv1d_cuda.causal_conv1d_bwd(
            x, conv1d_weight, conv1d_bias, dconv1d_out, None, None, None,
            dx, dconv1d_weight, dconv1d_bias, None, True
        )
...
class MambaInnerFn(torch.autograd.Function):
    ...
    def backward(ctx, dout):
        ...
        dx, dconv1d_weight, dconv1d_bias = causal_conv1d_cuda.causal_conv1d_bwd(
            x, conv1d_weight, conv1d_bias, dconv1d_out, None, None, dx, None, None, None, None, True
        )
